...
def build_lab():
    ...
    llav2C = ('llav2C', 'iNF517.gb', 'iNF517_v2_cobra.xml') # updated bigg model cobra names, use other version
...
def build_bigg2_new():
    ...
    # mmu = ('mmu', ['imm1415_chr1.gb', 'imm1415_chr2.gb', 'imm1415_chrx.gb', 'imm1415_chr3.gb', 'imm1415_chr4.gb', 'imm1415_chr5.gb', 'imm1415_chr7.gb', 'imm1415_chr6.gb', 'imm1415_chr10.gb', 'imm1415_chr8.gb', 'imm1415_chr11.gb', 'imm1415_chr9.gb', 'imm1415_chr14.gb', 'imm1415_chr12.gb', 'imm1415_chr13.gb', 'imm1415_chr15.gb', 'imm1415_chr16.gb', 'imm1415_chr17.gb', 'imm1415_chr18.gb', 'imm1415_chry.gb', 'imm1415_chr19.gb'], 'iMM1415.xml')    
    libSet = 'bigg2'
    models = [eco9, eco5, eco51, eco46, eco12, eco_core, eco15, eco29, eco3, eco33, eco24,\
              ...
              eco28, eco13, eco49, ssp]
    #models = [cgr, eco31] # incomplete genbank file, incoherent gene identifiers, usable identifers that should be fixed in source model``
